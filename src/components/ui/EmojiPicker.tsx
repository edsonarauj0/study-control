  ...
  return (
    ...
    >
      ...
      <EmojiPickerPrimitive.Search
        ...
        className="outline-hidden placeholder:text-muted-foreground flex h-8 w-full rounded-md bg-transparent py-3 text-sm disabled:cursor-not-allowed disabled:opacity-50 px-2"
